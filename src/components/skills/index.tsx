...
export default function Skills() {
  return (
    ...
    before:font-extrabold before:text-muted-foreground before:text-xl after:content-['</Skills>'] after:absolute after:right-0 after:-bottom-10 after:text-muted-foreground after:text-xl after:font-extrabold"
    >
